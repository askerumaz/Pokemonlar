    ...
    <div class="poke-info">
        ...
        <div class="small">
            <small class="poke-exp">
                <i class="fa fa-flask"></i>${pokemon.base_experience}exp
            </small>
            <small class="poke-weight">
                <i class="fa fa-flask"></i> ${pokemon.weight}kg
            </small>
        </div>
        <div class="poke-type"><img src="image/unc.ico" style="width: 10px;"> ${pokemonType}
